        ...
        return(
            ...
            <div className="movieDetails_Container">
                ...
                <div className="movieDetails_descriptionContainer">
                    ...
                    <p className="movieDetails_realTitle">{this.props.originalTitle} - {this.props.tagline ? this.props.tagline : ''}</p>
                    ...
                    <div>
                        <p className="movieDetails_description">{this.props.overview.substr(0, 400)}....</p>
                        <span className="movieDetails_genres">Generos: 
                            {this.props.genres.map((genre, i) =><p key={genre.i}>{genre.name }, </p>)} 
                        </span >
                    </div>
                    <div className="seasonsYepisodes_container">
                        <span className="seasons_description">Temporadas:<p>{this.props.seasons}</p></span>
                        <span className="episodes_description">Episodios:<p>{this.props.episodes}</p></span>
                    </div>
                </div>
            </div>
        )
